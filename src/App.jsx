  ...
  return (
    <>
      <div className="absolute top-0 left-0 w-full h-full -z-10 ">
        <Aurora
          colorStops={["#ffffffff", "#ff0000ff", "#000000ff"]}
          blend={0.5}
          amplitude={1.0}
          speed={0.5}
        />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="tools mt-32">
          ...
          <p className="text-base/loose text-center opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">My Profesional Skills</p>
        ...
        <div className="kontak mt-32 sm:p-10 p-0 relative z-10" id="contact">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-stretch">
            ...
            {/* Chat Room di kiri - Disamakan tinggi dan border-nya */}
            <div
            ...
            <div className="flex-1 relative">
              {/* Efek glow yang disesuaikan agar tidak terlalu dominan */}
      ...
      {/* 5. RENDER MODAL SERTIFIKAT BARU */}
      <CertificateModal
